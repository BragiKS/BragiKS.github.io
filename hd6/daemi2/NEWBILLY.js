...
function render() {
  ...
  var mv1 = mult(mv, translate(0.0, 0.4, 0.0));
  mv1 = mult(mv1, scalem(0.8, 0.05, 0.3));
  ...
  // Left wall
  mv1 = mult(mv, translate(-0.4, -0.1, 0.0));
  mv1 = mult(mv1, scalem(0.05, 1.05, 0.3));
  gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(mv1));
  gl.drawArrays(gl.TRIANGLES, 0, numVertices);

  // Right wall
  mv1 = mult(mv1, translate(16.0, 0.0, 0.0));
  gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(mv1));
  gl.drawArrays(gl.TRIANGLES, 0, numVertices);

  // Back wall
  mv1 = mult(mv, translate(0.0, -0.05, 0.145));
  mv1 = mult(mv1, scalem(0.8, 0.95, 0.01));
  gl.uniformMatrix4fv(modelViewMatrixLoc, false, flatten(mv1));
  gl.drawArrays(gl.TRIANGLES, 0, numVertices);
